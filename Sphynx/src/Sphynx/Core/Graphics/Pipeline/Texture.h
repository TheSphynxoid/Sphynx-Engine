...
#pragma region Enums
	...
	enum class TextureFormat : unsigned int {
		DepthComponent, DepthStencil, Red, Red8, Red8SNorm, Red16, Red16SNorm, RG, RG8, RG8SNorm, RG16, RG16SNorm, R3_G3_B2, RGB,
	...
	enum class TextureDataFormat : unsigned int {
		...
		UInt_8_8_8_8_REV, UInt_10_10_10_2, UInt_2_10_10_10_REV
	};
...
#pragma endregion
	...
	public:
		...
		//\Mipmap level 0
		static Texture* Create(const char* path, TextureType Type);
		static Texture* Create(const char* path, TextureType Type, int MipmapLevel, TextureFormat format, TextureWrappingMode warp,
